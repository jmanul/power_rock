...
for (const use of users) {
     ...
     for (const sound in use.favoritesSounds) {
...
//      if (!(repetidos.includes(sounds[i]))) {

//           repetidos.push(sounds[i]);
          
//           console.log(`el sonido ${sounds[i]} se repite ${n} veces`);
...
for (const i of sounds) {
     ...
     if (!(repetidos.includes(i))) {
          ...
          console.log(`el sonido ${i} se repite ${n} veces`);
